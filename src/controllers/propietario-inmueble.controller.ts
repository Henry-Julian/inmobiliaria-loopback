...
export class PropietarioInmuebleController {
  ...
  async find(
    ...
    return this.propietarioRepository.relacionpropinmueble(id).find(filter);
  }
  ...
  async create(
    ...
    return this.propietarioRepository.relacionpropinmueble(id).create(inmueble);
  }
  ...
  async patch(
    ...
    return this.propietarioRepository.relacionpropinmueble(id).patch(inmueble, where);
  }
  ...
  async delete(
    ...
    return this.propietarioRepository.relacionpropinmueble(id).delete(where);
  }
}
