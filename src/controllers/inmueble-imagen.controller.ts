...
export class InmuebleImagenController {
  ...
  async find(
    ...
    return this.inmuebleRepository.relacioninmuebleimagenes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.inmuebleRepository.relacioninmuebleimagenes(id).create(imagen);
  }
  ...
  async patch(
    ...
    return this.inmuebleRepository.relacioninmuebleimagenes(id).patch(imagen, where);
  }
  ...
  async delete(
    ...
    return this.inmuebleRepository.relacioninmuebleimagenes(id).delete(where);
  }
}
